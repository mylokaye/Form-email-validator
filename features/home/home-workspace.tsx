...
export function HomeWorkspace({ initialNews, initialRoadmap }: { initialNews: NewsResponse | null; initialRoadmap: RoadmapResponse | null }) {
  return (
    <div className="flex flex-col gap-6">
      <NewsStories initialData={initialNews} limit={6} sourceFilterLabels={{ 'Microsoft Dynamics': 'Dynamics', Meghan: 'Meghan' }} title="Latest news" description="The latest stories from your shared newsroom." showSourceFilter showViewAll />
